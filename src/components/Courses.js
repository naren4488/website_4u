      ...
      <div className="course-cards-container">
        ...
        <div className="course-card">
          ...
          <div className="course-card-body">
            <div className="course-requirments">
              <FontAwesomeIcon
                className="course-requirments-icon"
                icon={faCircleCheck}
              />
              <h6 className="course-requirements-sentence">
                No prior coding knowledge required
              </h6>
            </div>
            <div className="course-outcomes">
              <h6 className="course-outcomes-heading">Course Outcomes</h6>
              <p className="course-outcomes-content">
                Attain full proficiency in Python, enabling application
                development, data analysis, and exploration of advanced domains
                like ML & AI.
              </p>
            </div>
            <div className="course-outcomes">
            ...
            <div className="course-outcomes">
              ...
              <p className="course-outcomes-content">
                Python basics, loops, recursion, functions, string, list, tuple,
                set, dictionary, OOPs, libraries like numpy, pandas, matplotlib
                ... and much more!!
              </p>
            </div>
            <div className="course-learn-more">
              <HashLink className="course-link" to="/coursePage/python/#top">
                Explore Course &rarr;
              </HashLink>
        ...
        <div className="course-card">
          ...
          <div className="course-card-body">
            ...
            <div className="course-outcomes">
              <h6 className="course-outcomes-heading">Course Outcomes</h6>
              <p className="course-outcomes-content">
                Ability to build interactive and responsive websites.
              </p>
            </div>
            <div className="course-outcomes">
              <h6 className="course-outcomes-heading">Next Batch</h6>
              <p className="course-outcomes-content">Dates will be annouced soon</p>
            </div>
            <div className="course-outcomes">
              <h6 className="course-outcomes-heading">What you'll learn?</h6>
              <p className="course-outcomes-content">
                {" "}
                Html5, Css, Bootstrap, Web-Animations, Javascript, ES6, Rest
                Api's, Http server, DOM, Git, Github, Web Hosting... and much
                more!!
              </p>
            </div>
            <div className="course-learn-more">
              {/* <HashLink className="course-link" to="/coursePage/webdev/#top">
                Explore Course &rarr;
              </HashLink> */}
              <p style={{ color: "red", fontWeight: "bold", fontSize: "2rem" }}>
                Batch is already Going on !!
              </p>
              <p className="course-link">New Batch Coming in January 2024</p>
            </div>
          </div>
        </div>
        ...
        <div className="course-card">
          <div className="course-card-header">
            <h3 className="course-card-heading">
              Complete Java placement course
            </h3>
          ...
          <div className="course-card-body">
            ...
            <div className="course-outcomes">
              <h6 className="course-outcomes-heading">Course Outcomes</h6>
              <p className="course-outcomes-content">
                Ace all your placement interviews in style.{" "}
              </p>
            </div>
            <div className="course-outcomes">
              <h6 className="course-outcomes-heading">Next Batch</h6>
            ...
            <div className="course-outcomes">
              ...
              <p className="course-outcomes-content">
                {" "}
                Java basics, coditional statements, loops, patterns, recursion,
                strings, arrays, oops, exception handling ... and much more!!
              </p>
            </div>
            <div className="course-learn-more">
        ...
        <div className="course-card">
          ...
          <div className="course-card-body">
            <div className="course-requirments">
              ...
              />
              <h6 className="course-requirements-sentence">
                Basic Coding knowledge in java{" "}
              </h6>
            </div>
            <div className="course-outcomes">
              <h6 className="course-outcomes-heading">Course Outcomes</h6>
              <p className="course-outcomes-content">
                {" "}
                Learn the nitty gritty of data structures.{" "}
              </p>
            </div>
            <div className="course-outcomes">
            ...
            <div className="course-outcomes">
              ...
              <p className="course-outcomes-content">
                {" "}
                Complextiy Analysis, Stacks, Queues, Linked Lists, Trees, Tries,
                dynamic programming, greedy techniques... and much more!!
              </p>
            </div>
            <div className="course-learn-more">
